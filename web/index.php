...
<body>
	...
	<section>
		<div class="banner d-none d-md-block ">				
			<img src="imagenes/banner1.jpg" alt="Imagen de ciclas Bala Bike">			
		</div>
			
		<!--Descripcion de la pagina-->
		<article class="descripcion p-5 p-md-2">
			<h1>TIENDA ONLINE DE BICICLETAS Y CICLISMO URBANO</h1>
			<p>Encuentra las mejores ofertas en bicicletas fixie o single speed, bicicletas urbanas y bicis plegables.
			Además, también disponemos de bicicletas eléctricas y bicis de paseo para desplazarte por la ciudad.
			Y si ya tienes una bicicleta, descubre los mejores componentes, accesorios y equipamiento necesario.</p>
		</article>
		
		<section class="destacados">
			<h1 class="destacados-titulo p-5 p-md-2">RELACIONADO CON LOS PRODUCTOS QUE HAS MIRADO</h1>
			<!--Productos destacados de la pagina de inicio-->
			<section class="destacados-inicio">
				<!-- <span class="fa fa-chevron-left destacados-inicio-dir"></span> -->
				...
				<!-- <span class="fa fa-chevron-right destacados-inicio-dir"></span>	 -->
				<img class="destacados-inicio-dir" src="iconos/flechaDerecha.png">	
			</section>
		</section>
	</section>
