...
<html lang="en">
  <head>
    ...
    <title>Contacto | BALA BIKE</title>
  </head>
<body>
	...
	<section>
		<section class="contacto">
			<form action="" class="contacto-form">
				...
				<input type="email" class="nombre" placeholder="CORREO">
				<textarea name="" id="" cols="20" rows="5" class="mensaje" placeholder="MENSAJE"></textarea>
